...
TORCH_META_FUNC(special_hyp2f1) (const Tensor& self, const Tensor& a, const Tensor& b, const Tensor& c) {
  build(
    ...
    .add_borrowed_output(maybe_get_output)
...
TORCH_IMPL_FUNC(special_hyp2f1_out) (const Tensor& self, const Tensor& a, const Tensor& b, const Tensor& c, const Tensor& result) {
...
Tensor& special_hyp2f1_out(const Tensor& self, const Scalar& a, Tensor& b, Tensor& c, Tensor& result) {
  return at::special_hyp2f1(self, wrapped_scalar_tensor(a), b, c);
}
